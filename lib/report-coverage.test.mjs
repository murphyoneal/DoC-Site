...
const contamBlock = { field_status: 'present', promoted: [
  { name: 'FORMER MAIN STREET 66 GAS STATION', source: 'clm_cleanup', on_parcel: false, distance_m: 85, remediation_status: 'ACTIVE', facility_type: 'PETRO', cleanup_status: null, coordinate_quality: 'EXACT', documents_url: 'http://dep/docs', watch_url: 'http://dep/watch' },
  { name: 'JOES AUTOMOTIVE CLINIC', source: 'stcm_tank', on_parcel: true, distance_m: 0, remediation_status: null, facility_type: 'Retail Station', facility_status: 'CLOSED', cleanup_status: null, coordinate_quality: '4', documents_url: 'http://dep/docs2', watch_url: null },
