...
export function renderTransactionsBlock(tf) {
  ...
  const one = (c) => {
    ...
    return {
      ...
      amount: c.consideration ?? null,
      amountLabel: c.consideration == null ? null
        : (isSale ? `$${Number(c.consideration).toLocaleString('en-US')}`
                  : `$${Number(c.consideration).toLocaleString('en-US')} consideration`),
      nominal: !!c.nominal,
